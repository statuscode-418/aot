...
const eventScedule = () => {
  ...
  return (
    ...
    {Event_scedule.map((event, index) => (
        <div key={index} className='flex p-2 gap-2 lg:gap-6 text-white items-center justify-center w-[90%]'>
            <div  className={`left  h-auto lg:h-[150px] w-[400px] bg-[#0F2167] p-4 mt-[-120px] lg:mt-[-40px] ${event.number % 2 === 0 ? 'hidden' : ''}`}>
                {event.text}
            </div>
            ...
            <div className="mid_portion flex flex-col items-center justify-center">
                ...
                <div className="middle_stick border border-[#0F2167] border-[6px] h-[400px] lg:h-[200px] w-[0px]">

                </div>
            </div> 
            <div  className={`left border border-black h-auto lg:h-[150px] w-[400px] bg-[#0F2167] p-4 mt-[-120px] lg:mt-[-40px] ${event.number % 2 === 1 ? 'hidden' : ''}`}>
                {event.text}
            </div>
