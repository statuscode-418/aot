...
const DepartmentalNews = () => {
	return (
		<div
			className="flex justify-between text-blue-800 font-bold "
			style={{ height: "65vh" }}
		>
			...
			<div
				className="hidden sm:block md:block mx-5 self-center h-full mb-4"
				style={{ borderLeft: "2px solid black" }}
			></div>
			<div
				className="ml-auto mt-7 mr-16 border rounded-3xl bg-white overflow-auto scrollbar-hide"
				style={{ height: "58vh", width: "60vh" }}
			>
