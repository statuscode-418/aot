            ...
            <div className='flex flex-col md:flex-row ml-8'>
                ...
                <div className='flex-1 mb-8 md:mb-0'>
                    ...
                    <div className="flex items-center mt-2">
                        <IoCall size={30} />
                        <div className="ml-2">
                        <a href="tel:+916969696969" target="_blank" className="text-lg ml-2">+91 6969696969</a> 
                        </div>
                    </div>
                    <div className="flex items-center mt-2">
                        <MdEmail size={30} />
                        <div className="ml-2">
                        <a href='mailto:dilip.kr.maity@aot.edu.in' target="_blank" className="text-lg ml-2">dilip.kr.maity@aot.edu.in</a> 
                        </div>
                    </div>
                        ...
                        <div>
                            <div>
                                <nav className="flex flex-col md:flex-row space-x-0 md:space-x-4 justify-center mt-4">
                                    <a href="#" className="text-gray-300 hover:text-white mb-2 md:mb-0 mr-2 md:mr-0">
                                        Academics
                                    </a>
                                    <a href="#" className="text-gray-300 hover:text-white mb-2 md:mb-0 mr-2 md:mr-0">
                                        Research
